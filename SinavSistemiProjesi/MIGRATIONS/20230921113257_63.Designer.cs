...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.Dersler", b =>
                {
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.Notlar", b =>
                {
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.Roller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.Notlar", b =>
                {
                    b.HasOne("$safeprojectname$.Entities.Dersler", "Dersler")
                        .WithMany("Notlar")
                        .HasForeignKey("DersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("$safeprojectname$.Entities.User", "User")
                        .WithMany("Notlar")
            ...
            modelBuilder.Entity("$safeprojectname$.Entities.User", b =>
                {
                    b.HasOne("$safeprojectname$.Entities.Roller", "Rol")
                        .WithMany("users")
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
